...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO commander (Nbre_Plat_Com, CodePlat, NumDemande) VALUES (%s, %s, %s)",
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr bgcolor="#D5EDB3">
    ...
    <td width="378" height="50" id="logo" valign="bottom" align="center" nowrap="nowrap"><p>Formulaire_commander</p>
    </td>
    <td width="100%">&nbsp;</td>
  </tr>
 ...
 <tr>
   ...
   <table border="0" cellspacing="0" cellpadding="2" width="504">
        <tr>
<td valign="top" bgcolor="#FF0000" class="bodyText"><p>&nbsp;</p>           
    <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
      <table align="center">
        <tr valign="baseline">
          <td nowrap align="right">Nbre_Plat_Com:</td>
          <td><input type="text" name="Nbre_Plat_Com" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
